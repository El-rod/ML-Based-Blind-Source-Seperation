...
def generate_demod_testmixture(soi_type, interference_sig_type):
    ...
    pickle.dump((all_sig_mixture, all_sig1, all_bits1), open(
        os.path.join('dataset', f'GroundTruth_TestSet1Example_Dataset_{soi_type}_{interference_sig_type}.pkl'), 'wb'),
                protocol=4)
    ...
    np.save(os.path.join('dataset', f'TestSet1Example_testmixture_{soi_type}_{interference_sig_type}_metadata'),
            meta_data)
