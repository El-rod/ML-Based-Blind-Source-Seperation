...
soi_type = 'QPSK'
interference_sig_type = 'CommSignal3∨CommSignal2'
sig_types = [f'{soi_type}_CommSignal3_mixture', f'{soi_type}_CommSignal2_mixture']

class DatasetQpskCommsignal3Commsignal2Mixture(tfds.core.GeneratorBasedBuilder):
