...
soi_type = 'QPSK'
interference_sig_type = 'CommSignal3∨EMISignal1'
sig_types = [f'{soi_type}_CommSignal3_mixture', f'{soi_type}_EMISignal1_mixture']


class DatasetQpskCommsignal3Emisignal1Mixture(tfds.core.GeneratorBasedBuilder):
