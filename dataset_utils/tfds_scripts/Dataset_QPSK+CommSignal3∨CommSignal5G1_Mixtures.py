...
soi_type = 'QPSK'
interference_sig_type = 'CommSignal3∨CommSignal5G1'
sig_types = [f'{soi_type}_CommSignal3_mixture', f'{soi_type}_CommSignal5G1_mixture']


class DatasetQpskCommsignal3Commsignal5g1Mixture(tfds.core.GeneratorBasedBuilder):
