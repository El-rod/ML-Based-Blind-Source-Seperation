...
# tfds build dataset_utils/tfds_scripts/Ariel_Dataset_QPSK_CommSignal2+CommSignal5G1_Mixtures.py --data_dir serverdata/tfds/
# tfds build dataset_utils/tfds_scripts/Ariel_Dataset_QPSK_CommSignal2+EMISignal1_Mixtures.py --data_dir tfds/
# tfds build dataset_utils/tfds_scripts/Ariel_Dataset_QPSK_EMISignal1+CommSignal5G1_Mixtures.py --data_dir tfds/
# tfds build dataset_utils/tfds_scripts/Ariel_Dataset_QPSK_CommSignal3+CommSignal2_Mixtures.py --data_dir serverdata/tfds/
# tfds build dataset_utils/tfds_scripts/Ariel_Dataset_QPSK_CommSignal3+CommSignal5G1_Mixtures.py --data_dir serverdata/tfds/
# tfds build dataset_utils/tfds_scripts/Ariel_Dataset_QPSK_CommSignal3+EMISignal1_Mixtures.py --data_dir serverdata/tfds/
# tfds build dataset_utils/tfds_scripts/Ariel_Dataset_QPSK_CommSignal2_short_Mixture.py --data_dir tfds/
# tfds build dataset_utils/tfds_scripts/Ariel_Dataset_8PSK_CommSignal2+EMISignal1_Mixtures.py --data_dir serverdata/tfds/
# tfds build dataset_utils/tfds_scripts/Ariel_Dataset_8PSK_CommSignal2_Mixture.py --data_dir tfds/
# tfds build dataset_utils/tfds_scripts/Ariel_Dataset_8PSK_EMISignal1_Mixture.py --data_dir tfds/
# tfds build dataset_utils/tfds_scripts/Ariel_Dataset_16PSK_CommSignal2_Mixture.py --data_dir serverdata/tfds/
# tfds build dataset_utils/tfds_scripts/Ariel_Dataset_16PSK_EMISignal1_Mixture.py --data_dir serverdata/tfds/
# tfds build dataset_utils/tfds_scripts/Ariel_Dataset_16PSK_CommSignal2+EMISignal1_Mixtures.py --data_dir serverdata/tfds/
...
# python dataset_utils/example_preprocess_npy_dataset.py QPSK_Comm2andEMI1
