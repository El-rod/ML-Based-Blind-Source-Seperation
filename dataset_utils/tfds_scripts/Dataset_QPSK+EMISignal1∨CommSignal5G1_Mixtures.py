...
soi_type = 'QPSK'
interference_sig_type = 'EMISignal1∨CommSignal5G1'
sig_types = [f'{soi_type}_EMISignal1_mixture', f'{soi_type}_CommSignal5G1_mixture']


class DatasetQpskEMISignal1andCommSignal5G1Mixture(tfds.core.GeneratorBasedBuilder):
