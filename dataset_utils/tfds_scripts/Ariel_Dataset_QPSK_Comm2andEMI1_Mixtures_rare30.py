...
class DatasetQpskComm2andEmi1MixtureRare30(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager: tfds.download.DownloadManager):
        ...
        path = os.path.join('dataset', f'Dataset_{soi_type}_{interference_sig_type}_Mixture_rare30')
